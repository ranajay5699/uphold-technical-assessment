...
CURRENCY_PAIRS=<Comma-separated list of currency pairs (default: BTC-USD), optional>
CHECK_INTERVAL_MS=<Enter a whole number, not a decimal (default: 5000), optional> 
PRICE_THRESHOLD=<Enter any positive number (default: 0.01), optional>
```
4. `npm install`
